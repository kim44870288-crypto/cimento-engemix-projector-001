      ...
      <nav className="container mx-auto px-4 lg:px-14 py-10 flex flex-col gap-12 lg:gap-16 lg:flex-row lg:flex-wrap lg:justify-between lg:items-start">
        ...
        <div className="w-full flex flex-col lg:flex-row gap-8 items-center lg:justify-between">
          ...
          >
            ...
            <a href="#" aria-label="YouTube" data-testid="social-youtube" className="w-11 h-11 flex items-center justify-center hover:scale-110 transition">
            ...
            <a href="#" aria-label="Instagram" data-testid="social-instagram" className="w-11 h-11 flex items-center justify-center hover:scale-110 transition">
